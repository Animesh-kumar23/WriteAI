  ...
  return (
    <DashboardLayout>
      <main className="max-w-2xl px-4 py-6 mx-auto">
        <h1 className="text-slate-900 dark:text-slate-50 text-xl md:text-2xl font-bold mb-2">
          Profile
        </h1>
        ...
        <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-6 sm:p-8 shadow-sm dark:shadow-black/20">
          <form onSubmit={handleSubmit} className="space-y-8">
            {/* Avatar Section */}
            <div className="flex flex-col items-center gap-6 pb-6 border-b border-slate-100 dark:border-slate-700">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-3">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-violet-600 dark:text-violet-400 bg-violet-50 dark:bg-violet-500/10 rounded-lg transition-all duration-200 hover:bg-violet-100 dark:hover:bg-violet-500/20 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:ring-offset-2 dark:focus:ring-offset-slate-800 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                ...
                {user?.avatar && (
                  <button
                    ...
                    disabled={isUploadingAvatar || isDeletingAvatar}
                    className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-500/10 rounded-lg transition-all duration-200 hover:bg-red-100 dark:hover:bg-red-500/20 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 dark:focus:ring-offset-slate-800 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {isDeletingAvatar ? (
                      <>
              ...
              <p className="text-slate-500 dark:text-slate-400 text-xs text-center max-w-xs">
